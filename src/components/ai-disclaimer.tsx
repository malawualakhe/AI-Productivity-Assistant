  ...
  return (
    <div className="flex items-start gap-3 rounded-lg border border-border bg-muted/50 p-4 text-sm text-muted-foreground">
      ...
      <div>
        ...
        <p>
          AI-generated content may contain inaccuracies. Please review and verify all outputs before
          using them in professional contexts. Do not share sensitive personal or confidential
          information.
        </p>
      </div>
    </div>
